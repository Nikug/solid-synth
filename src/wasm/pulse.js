...
class KissFftWrapperWasm {
  constructor(size) {
    ...
    this.cin = new Float32Array(kissFFTModule.HEAPU8.buffer, this.inptr, this.size * 2)
  }
  ...
  fft = function (inputArray) {
    ...
    const cout = new Float32Array(kissFFTModule.HEAPU8.buffer, outptr, this.size * 2)
